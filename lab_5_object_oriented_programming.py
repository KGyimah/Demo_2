...
Original file is located at
    https://colab.research.google.com/drive/1g7EY7qKMW2E7gb8nxcloqvxmEbuvUokj
...
identity('John')    # Throws an error because `identity` is not under a class, thus it is a regular function, expecting two arguments
...
Selinam.identity("Selinam")

Selorm.identity('Selorm')
...
Student.identity(Selorm,"Selorm") # This is the same as Jessica.identity()
