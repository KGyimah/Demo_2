# -*- coding: utf-8 -*-
"""Object Oriented Programming_Jethro.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iDAryUcjCoxTJKsWeGXVX7lICz5Kr730
...
A classe define what attributes an instance of this type will have, like color, but not the value of those attributes for a specific object.
...
### Consider the this example
                                  ...
                                  Height,color, weight, education, address --------> Attributes
                                  
                                  write,run,sing, code,read,analyze,dance   -------> methods
...
"""### Note
Calling an method from an object is the same as passing the object as an argument to a method from the class.

Check the examples below:
"""

Student.identity(s1,"Pamela") # This is the same as s1.identity()
...
s1 = Student("Bright","Data Science",2021)
s2 = Student("Ola","Python programming",2020)
s3 = Student("Jemima","Web design",2021)
s4= Student("Samuel","Business Intelligence with Tableau",2019)
...
class Shirt: #Shirt ----> Class name. It always starts with a capital letter
    def __init__(self,category,colour,size,price): # the __init__ serves as a constructor
                                                   # the self argument is a special argument which serves as a holder of the other arguments,
                                                   # the self argument allows the other arguments to be referenced in the class
                                                   # It also stand- in for a particular object used in the class definition
...
shirt_1 = Shirt('T-shirt','blue',28,15)
...
Instance level data may include intance attributes and instance methods whilst  class data may include class attributes and class methods.
...
emp1 = Employee('Joel',5000)

emp2 = Employee('Nancy',2000)
...
class Customer:
    ...
    # Adding a decorated balance() method returning _balance        
    @property
    def balance(self):
